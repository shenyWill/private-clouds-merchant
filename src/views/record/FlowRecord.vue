<template>
    <div class="flow-record">
        ...
        <div class="data-statistics">
            <h2 class="data-statistics-title">流量统计</h2>
        ...
        <div class="flow-statistics">
            <FlowStatistics @drawMap="drawMap"></FlowStatistics>
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  mounted () {
    ...
    this.drawMap('data-map', flowMap.option);
  },
  computed: {
    timeList () {
      return [...menu];
...
.flow-record {
  .data-statistics,.equipment-statistics,.flow-statistics {
